...
<div class="container" id="reg">
    ...
    <input type="checkbox" class="form-check-input" id="publisher" name="publisher">
    <label class="form-check-label  text-md-right" for="publisher">Желая да предлагам свои продукти</label>
  </div>
