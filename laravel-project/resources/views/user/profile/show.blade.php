            ...
            <div class="card">
                ...
                <div class="form-group row" id="imagess">
                       ...
                       <div class="form-group row">
                            <label for="detail_about" class="col-md-4 col-form-label text-md-right">Електронна поща </label>
...
<script>
	...
	if(!$this.hasClass('panel-collapsed')) {
        ...
        <ul class="cat">
                ...
                <li><a href="{{route('user.profile.edit',$user->id)}}"> Промени профила </a></li>
