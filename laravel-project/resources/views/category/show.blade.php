        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="form-group row" id="imagess">
                            ...
                            <div class="col-md-6">
                            <img src="{{URL::to($category->logo)}}" alt="" height="70px" width="80px">
                       ...
                       <div class="form-group row" >
                            <label for="detail_about" class="col-md-4 col-form-label text-md-right">Описание на категорията </label>

                            <div class="col-md-6">
                            {!! nl2br($category->details) !!}
                            </div>
                        </div>
