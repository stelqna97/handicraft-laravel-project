...
<div class="container" id="create">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Създай нова категория  </div>
                ...
                <div class="form-group row">
                       ...
                       <div class="form-group row">
                            <label for="details" class="col-md-4 col-form-label text-md-right">За категорията </label>
                        ...
                        <div class="form-group row">
                            <label for="logo" class="col-md-4 col-form-label text-md-right">Снимка </label>
                            <div class="col-md-6">
