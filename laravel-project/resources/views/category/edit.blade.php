...
<div class="container" id="create">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Промени категория {{$category->name}}  </div>
                ...
                <div class="form-group row" id="iamgess">
                            <label for="logo" class="col-md-4 col-form-label text-md-right"> </label>
                           
                            <div class="col-md-6">
                            <img src="{{URL::to($category->logo)}}" alt="" height="100px" width="120px">

                            <input type="hidden" name="old_logo"  value="{{$category->logo}}" multiple />
                ...
                <div class="form-group row">
                       ...
                       <div class="form-group row">
                            <label for="detail_about" class="col-md-4 col-form-label text-md-right">Детайли </label>

                            <div class="col-md-6">
                            <textarea name="detail_about" id="detail_about" cols="30" rows="6"  class="form-control">{{$category->details}}</textarea>
                            </div>
                        </div>
