...
<div class="row justify-content-center" id="create">
  ...
  <thead>
    <tr>
    <th width="150px"> #</th>
<th width="150px"> Потребител</th>
<th width="200px">Продукт</th>
<th width="100px">Коментар</th>
<th width="100px">Ретинг</th>

    </tr>
  </thead>
  <tbody>
  @foreach($rating as $rtg)    <tr>
  <th>{{ $rtg->id }}</th>
                                <td>{{ $rtg->user_id }}</td>
                                <td>{{ $rtg->product_id }}</td>
                                <td>{{ $rtg->comment }}</td>
                                <td>
...
<div class="form-group row">
    <label for="filter" class="col-md-4 col-form-label text-md-right">Коментар</label>
    <div class="col-md-6">
    <input type="text" class="form-control" id="filter" name="comment"  value="{{$comment ?? ''}}">
    </div>
  </div>
  <div class="form-group row">
    <label for="filter" class="col-md-4 col-form-label text-md-right">Ратинг</label>
    <div class="col-md-6">
    <input type="text" class="form-control" id="filter" name="star"  value="{{$star ?? ''}}">
    </div>
  </div>
  <div class="form-group row">
...
<div class="col-md-6" id="sort">
       ...
       <li><a href="#">@sortablelink('star','ратинг ','asc_suffix'     )</a></li>
