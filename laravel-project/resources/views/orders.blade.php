  ...
  @foreach($orders as $order)
                        <?php
                            ...
                            <tr>
                                ...
                                <td>{{ $order->firs_name }} {{ $order->last_name }} </td>
                                ...
                                <td id="action">
      <a href="{{ route('admin.orders.edit',$order->id)}}"><button type="button"  class="btn">
      <i class="fa fa-edit" style="font-size:20px;color:#cccc00" id="edit" ></i></button></a>

        
      <form action="{{ route('admin.orders.delete',$order->id)}}" method="POST" class="float-left" id="delete" >
...
<div class="form-group row">
    ...
    <div class="col-md-6">
    <input type="text" class="form-control" id="filter" name="firstname"  value="{{$firstname ?? ''}}">
    </div>
  </div>
  
  <div class="form-group row">
    <label for="filter" class="col-md-4 col-form-label text-md-right">Фамилия</label>
    <div class="col-md-6">
    <input type="text" class="form-control" id="filter" name="lastname"  value="{{$lastname ?? ''}}">
    </div>
  </div>

  <div class="form-group row">
    <label for="filter" class="col-md-4 col-form-label text-md-right">Номер на поръчката</label>
    <div class="col-md-6">
    <input type="text" class="form-control" id="filter" name="order_number"  value="{{$order_number ?? ''}}">
    </div>
    </div>

    <div class="form-group row">
    <label for="filter" class="col-md-4 col-form-label text-md-right">Статус</label>
    <div class="col-md-6">
    <input type="text" class="form-control" id="filter" name="status" value="{{$status ?? ''}}">
    </div>
    </div>


    <div class="form-group row">
    <label for="filter" class="col-md-4 col-form-label text-md-right">Количество</label>
    <div class="col-md-6">
    <label for="filter" class="col-sm-35 col-form-label">  Минимална количество</label>
    <input type="number" class="form-control" id="filter" name="quantitymin" min="1"  value="{{$quantitymin ?? ''}}">
    <label for="filter" class="col-sm30 col-form-label">Максимална количество</label>
    <input type="number" class="form-control" id="filter" name="quantitymax" min="1"  value="{{$quantitymax ?? ''}}">
    </div>
   </div>
...
<li><a  href="#">@sortablelink('user_id','потребител ','asc_suffix'   )</a></li>
