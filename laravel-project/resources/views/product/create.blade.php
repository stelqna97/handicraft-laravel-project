    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <input type="hidden" name="user_id" value="{{Auth::user()->id}}"/>
                <div class="card-header">Създай нов продукт  </div>
                ...
                <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="product_name" type="name" class="form-control " name="product_name"   autofocus>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="product_code" type="name" class="form-control " name="product_code"   autofocus>
                            </div>
                        </div>
           
                       <div class="form-group row">
                            <label for="details" class="col-md-4 col-form-label text-md-right">За продукта </label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                            <label for="logo" class="col-md-4 col-form-label text-md-right">Цена в лева </label> 
                            <div class="col-md-6">     
<input type="number" name="product_price" class="form-control "   min="0" id="product_price" class="" value="{{old('product_price')}}" title="" required="required">
</div>
</div>
...
<div class="form-group row">
    ...
    @foreach($brands as $brand )
        <option value="{{$brand ->id}}" name="brand_id">{!! $brand ->name !!}</option>
    @endforeach
</select>        
</div>
</div>
