    ...
    <div class="col-md-12" id="details" >
                ...
                <form  method="POST" action="{{route('ratting.store')}}"  enctype="multipart/form-data" >
                                        ...
                                        <textarea class="form-control animated" cols="50" id="new-review" name="comment" placeholder="Enter your review here..." rows="5"></textarea>
                                            ...
                                            <br/>
                                            <button class="btn btn-success">Промени</button>
                ...
                <form  method="POST" action="{{route('rating.update',$product->id)}}"  enctype="multipart/form-data" >
                                            
                                            @csrf 
                                            @method('POST')
                                        <h4 class="product-title" style="font-weight:bold">Промени своя рейтинг </h4>
                                        <div class="rating">
                                        <input type="hidden" name="_method" value="POST">
                                            <input id="ratings-hidden" name="rating" type="hidden"> 
                                        <textarea class="form-control animated" cols="50" id="new-review" name="comment"  rows="5">{{$editrtg->comment}}</textarea>
                                            <input id="input-1" name="star" class="rating rating-loading" data-min="0" data-max="5" value="{{$editrtg->star}}" data-step="1"  data-size="xs">
                                            <input type="hidden" name="product_id" required="" value="{{ $product->id }}">
                                            <input type="hidden" name="user_id" required="" value="{{ auth()->user()->id }}">
                                            <br/>
                                            <button class="btn btn-primary">Промени</button>
