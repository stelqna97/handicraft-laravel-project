...
<div class="container" id="create">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Количка </div>
                ...
                <div class="card-body">
                        ...
                        <div class="card">
                            ...
                            @if(($carts->count())>0)
                                ...
                                <th scope="col"></th>
                                    ...
                                    <th scope="col" width="120">Име на продукта</th>
                        ...
                        <?php
                                $image_products=DB::table('products')->where('id',$cart->products_name)->first();
                                $images=DB::table('product_images')->where('product_id',$cart->product_id)->first();
                            ?>
                            <tr>
                                <td></td>
                            <td class="cart_product">
                            
                                        <img src="{{URL::to($images->name)}}" alt="" height="70px" width="80px">
                                </td>
                                ...
                                <td class="cart_quantity">
                                    <div class="cart_quantity_button">
                                        <input class="cart_quantity_input" type="number" style="width:30px;" name="quantity" value="{{$cart->quantity}}" autocomplete="off" size="2">
                                        @if($cart->quantity>1)
                                        @endif
                                    </div>
                                </td>
                                ...
                                <td class="cart_delete">
                                    <a class="cart_quantity_delete" href="{{route('cart.remove',$cart->id)}}"><i class="fa fa-times"></i></a>
                                </td>
                            </tr>
                        @endforeach
@else
...
<script>
	...
	if(!$this.hasClass('panel-collapsed')) {
        ...
        <ul class="cat">
                ...
                <li><a href="{{ route('cart.clear') }}" class="btn btn-danger btn-block mb-4">Изпразни количката</a></li>
                <li><a href="{{ route('checkout.index') }}" class="btn btn-success btn-lg btn-block">Поръчай</a></li>               
